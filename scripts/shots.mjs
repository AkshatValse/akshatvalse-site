...
const CASES = [
  ...
  { name: '18-note-diffusion-light', url: '/notes/grading-a-diffusion-model', w: 1440, h: 900, scheme: 'light', full: true },
  { name: '19-note-diffusivity-dark', url: '/notes/effective-diffusivity-cosine-potential', w: 1440, h: 900, scheme: 'dark', full: true },
  { name: '20-note-mala-light', url: '/notes/what-the-metropolis-correction-buys', w: 1440, h: 900, scheme: 'light', full: true },
  { name: '21-notes-index', url: '/notes', w: 1440, h: 900, scheme: 'light', full: true },
